...
exports.run = async (bot, message, args) => {
    ...
    await message.channel.send({files: [
        {
            attachment: `https://www.novaragnarok.com/ROChargenPHP/characterhead/${char}`, // avatar image url
            name: "head.png" // name of image sended
        }
    ]});
...
exports.help = {
    ...
    usage: '?head hauren | ?head hauren (3/5)'
}